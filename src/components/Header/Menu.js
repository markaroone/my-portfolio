  ...
  return (
    <nav className={styles.menu}>
      ...
      <ul className={styles.socials}>
        <li>
          <a href='https://www.instagram.com/markaroone/' target='_blank'>
        ...
        <li>
          <a href='https://github.com/markaroone' target='_blank'>
            <ion-icon name='logo-github'></ion-icon>
          </a>
        </li>
        <li>
          <a href='https://gitlab.com/markaroone' target='_blank'>
